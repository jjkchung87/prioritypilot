...
//         const golferHTML = `<tr data-golfer_id="${golfer.id}"><td data-golfer_id="${golfer.id}">${golfer.owgr}</td><td data-golfer_id="${golfer.id}"><img class="golfer-image" src="${golfer.id}">${golfer.first_name} ${golfer.last_name}</td></tr>`
...
//             let $golferDiv = `<div>${golfer.first_name} ${golfer.last_name}</div>`
